	...
	public endScreen() {
		...
		learnMore.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				try {
					Desktop.getDesktop().browse(new URI("https://girlup.org/schoolcycle/#sthash.5RPInJdY.XwqWG6rx.dpbs"));
		...
		Text l = new Text(
				"This time it only took you only 25 minutes to get to school. You are energized and ready for a new day!"
